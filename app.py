...
def main():
    ...
    if choice == "Create":
        ...
        if st.button("Add Task"):
            ...
            st.success("Successully Added Data: {} ".format(task))
        ...
        st.subheader("Edit/Ipdate Items")
        result = view_all_data()
        df = pd.DataFrame(result,columns=['Task','Status','Due Date'])
        ...
        if selected_result:
            ...
            if st.button("Update Task"):
                ...
                st.success("Successully Upadated:: {} To ::{}".format(task,new_task))
        ...
        if st.button("Delete Task {}".format(selected_task)):
            delete_data(selected_task)
            st.success("Task {} has been successfully Delete".format(selected_task))
